...
namespace Laboratory1
{
    public partial class Form1 : Form
    {
        ...
        {
            if (comboBox1.Text == "Алфавиту (возрастание)")
            {
            ...
            if (comboBox1.Text == "Алфавиту (убывание)")
            {
                List<String> list = new List<String>();
                foreach (var item in listBox1.Items)
                    list.Add(item.ToString());
            ...
            if (comboBox1.Text == "Длина слова (возрастание)")
            {
                List<String> list = new List<String>();
                foreach (var item in listBox1.Items)
                    list.Add(item.ToString());
            ...
            if (comboBox1.Text == "Длина слова (убывание)")
            {
                List<String> list = new List<String>();
                foreach (var item in listBox1.Items)
                    list.Add(item.ToString());
        ...
        {
            if (comboBox2.Text == "Алфавиту (возрастание)")
            {
                List<String> list = new List<String>();
            ...
            if (comboBox2.Text == "Алфавиту (убывание)")
            {
                List<String> list = new List<String>();
                foreach (var item in listBox2.Items)
                    list.Add(item.ToString());
            ...
            if (comboBox2.Text == "Длина слова (возрастание)")
            {
                List<String> list = new List<String>();
                foreach (var item in listBox2.Items)
                    list.Add(item.ToString());
            ...
            if (comboBox2.Text == "Длина слова (убывание)")
            {
                List<String> list = new List<String>();
                foreach (var item in listBox2.Items)
                    list.Add(item.ToString());
